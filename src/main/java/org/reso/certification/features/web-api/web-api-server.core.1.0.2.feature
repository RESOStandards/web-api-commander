Feature: Web API Server 1.0.2 Core Certification
  ...
  @orderby-timestamp-asc-filter-int-gt @core
  ...
  @orderby-timestamp-desc-filter-int-gt @core
  ...
  @filter-enum-multi-has-and @core
