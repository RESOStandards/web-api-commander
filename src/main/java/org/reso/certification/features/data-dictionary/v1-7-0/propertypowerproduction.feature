...
Feature: PropertyPowerProduction
  ...
  Scenario: PowerProductionAnnualStatus
    ...
    Then "PowerProductionAnnualStatus" is defined as a single-valued enumeration
    And "PowerProductionAnnualStatus" standard enumeration values exist in the metadata
  ...
  Scenario: PowerProductionType
    ...
    Then "PowerProductionType" is defined as a single-valued enumeration
