Feature: Timestamp Testing
  ...
  Scenario: DocumentsChangeTimestamp
    ...
    And "DocumentsChangeTimestamp" values are not null
  ...
  Scenario: MajorChangeTimestamp
    ...
    And "MajorChangeTimestamp" values are not null
  ...
  Scenario: ModificationTimestamp
    ...
    And "ModificationTimestamp" values are not null
  ...
  Scenario: OffMarketTimestamp
    ...
    And "OffMarketTimestamp" values are not null
  ...
  Scenario: OnMarketTimestamp
    ...
    And "OnMarketTimestamp" values are not null
  ...
  Scenario: OriginalEntryTimestamp
    ...
    And "OriginalEntryTimestamp" values are not null
  ...
  Scenario: PendingTimestamp
    ...
    And "PendingTimestamp" values are not null
  ...
  Scenario: PhotosChangeTimestamp
    ...
    And "PhotosChangeTimestamp" values are not null
  ...
  Scenario: PriceChangeTimestamp
    ...
    And "PriceChangeTimestamp" values are not null
  ...
  Scenario: StatusChangeTimestamp
    ...
    And "StatusChangeTimestamp" values are not null
  ...
  Scenario: VideosChangeTimestamp
    ...
    And "VideosChangeTimestamp" values are not null
