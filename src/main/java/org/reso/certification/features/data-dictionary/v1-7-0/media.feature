...
Feature: Media
  ...
  Scenario: ImageOf
    ...
    And "ImageOf" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: MediaCategory
    ...
    And "MediaCategory" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: MediaType
    ...
    And "MediaType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Doc | doc |
      | Docx | docx |
      | Gif | gif |
  ...
  Scenario: Permission
    ...
    And "Permission" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
