Feature: Integer Testing
  ...
  Scenario: Bathrooms123
    ...
    And "Bathrooms123" values are not null
  ...
  Scenario: BathroomsFull
    ...
    And "BathroomsFull" values are not null
  ...
  Scenario: BathroomsHalf
    ...
    And "BathroomsHalf" values are not null
  ...
  Scenario: BathroomsOneQuarter
    ...
    And "BathroomsOneQuarter" values are not null
  ...
  Scenario: BathroomsPartial
    ...
    And "BathroomsPartial" values are not null
  ...
  Scenario: BathroomsThreeQuarter
    ...
    And "BathroomsThreeQuarter" values are not null
  ...
  Scenario: BathroomsTotalInteger
    ...
    And "BathroomsTotalInteger" values are not null
  ...
  Scenario: BedroomsPossible
    ...
    And "BedroomsPossible" values are not null
  ...
  Scenario: BedroomsTotal
    ...
    And "BedroomsTotal" values are not null
  ...
  Scenario: BuyerAgentKeyNumeric
    ...
    And "BuyerAgentKeyNumeric" values are not null
  ...
  Scenario: BuyerOfficeKeyNumeric
    ...
    And "BuyerOfficeKeyNumeric" values are not null
  ...
  Scenario: BuyerTeamKeyNumeric
    ...
    And "BuyerTeamKeyNumeric" values are not null
  ...
  Scenario: CoBuyerAgentKeyNumeric
    ...
    And "CoBuyerAgentKeyNumeric" values are not null
  ...
  Scenario: CoBuyerOfficeKeyNumeric
    ...
    And "CoBuyerOfficeKeyNumeric" values are not null
  ...
  Scenario: CoListAgentKeyNumeric
    ...
    And "CoListAgentKeyNumeric" values are not null
  ...
  Scenario: CoListOfficeKeyNumeric
    ...
    And "CoListOfficeKeyNumeric" values are not null
  ...
  Scenario: ConcessionsAmount
    ...
    And "ConcessionsAmount" values are not null
  ...
  Scenario: CumulativeDaysOnMarket
    ...
    And "CumulativeDaysOnMarket" values are not null
  ...
  Scenario: DaysOnMarket
    ...
    And "DaysOnMarket" values are not null
  ...
  Scenario: DistanceToBusNumeric
    ...
    And "DistanceToBusNumeric" values are not null
  ...
  Scenario: DistanceToElectricNumeric
    ...
    And "DistanceToElectricNumeric" values are not null
  ...
  Scenario: DistanceToFreewayNumeric
    ...
    And "DistanceToFreewayNumeric" values are not null
  ...
  Scenario: DistanceToGasNumeric
    ...
    And "DistanceToGasNumeric" values are not null
  ...
  Scenario: DistanceToPhoneServiceNumeric
    ...
    And "DistanceToPhoneServiceNumeric" values are not null
  ...
  Scenario: DistanceToPlaceofWorshipNumeric
    ...
    And "DistanceToPlaceofWorshipNumeric" values are not null
  ...
  Scenario: DistanceToSchoolBusNumeric
    ...
    And "DistanceToSchoolBusNumeric" values are not null
  ...
  Scenario: DistanceToSchoolsNumeric
    ...
    And "DistanceToSchoolsNumeric" values are not null
  ...
  Scenario: DistanceToSewerNumeric
    ...
    And "DistanceToSewerNumeric" values are not null
  ...
  Scenario: DistanceToShoppingNumeric
    ...
    And "DistanceToShoppingNumeric" values are not null
  ...
  Scenario: DistanceToStreetNumeric
    ...
    And "DistanceToStreetNumeric" values are not null
  ...
  Scenario: DistanceToWaterNumeric
    ...
    And "DistanceToWaterNumeric" values are not null
  ...
  Scenario: DocumentsCount
    ...
    And "DocumentsCount" values are not null
  ...
  Scenario: Elevation
    ...
    And "Elevation" values are not null
  ...
  Scenario: EntryLevel
    ...
    And "EntryLevel" values are not null
  ...
  Scenario: FireplacesTotal
    ...
    And "FireplacesTotal" values are not null
  ...
  Scenario: ListAgentKeyNumeric
    ...
    And "ListAgentKeyNumeric" values are not null
  ...
  Scenario: ListOfficeKeyNumeric
    ...
    And "ListOfficeKeyNumeric" values are not null
  ...
  Scenario: ListTeamKeyNumeric
    ...
    And "ListTeamKeyNumeric" values are not null
  ...
  Scenario: ListingKeyNumeric
    ...
    And "ListingKeyNumeric" values are not null
  ...
  Scenario: MainLevelBathrooms
    ...
    And "MainLevelBathrooms" values are not null
  ...
  Scenario: MainLevelBedrooms
    ...
    And "MainLevelBedrooms" values are not null
  ...
  Scenario: MobileLength
    ...
    And "MobileLength" values are not null
  ...
  Scenario: MobileWidth
    ...
    And "MobileWidth" values are not null
  ...
  Scenario: NumberOfBuildings
    ...
    And "NumberOfBuildings" values are not null
  ...
  Scenario: NumberOfFullTimeEmployees
    ...
    And "NumberOfFullTimeEmployees" values are not null
  ...
  Scenario: NumberOfLots
    ...
    And "NumberOfLots" values are not null
  ...
  Scenario: NumberOfPads
    ...
    And "NumberOfPads" values are not null
  ...
  Scenario: NumberOfPartTimeEmployees
    ...
    And "NumberOfPartTimeEmployees" values are not null
  ...
  Scenario: NumberOfSeparateElectricMeters
    ...
    And "NumberOfSeparateElectricMeters" values are not null
  ...
  Scenario: NumberOfSeparateGasMeters
    ...
    And "NumberOfSeparateGasMeters" values are not null
  ...
  Scenario: NumberOfSeparateWaterMeters
    ...
    And "NumberOfSeparateWaterMeters" values are not null
  ...
  Scenario: NumberOfUnitsInCommunity
    ...
    And "NumberOfUnitsInCommunity" values are not null
  ...
  Scenario: NumberOfUnitsLeased
    ...
    And "NumberOfUnitsLeased" values are not null
  ...
  Scenario: NumberOfUnitsMoMo
    ...
    And "NumberOfUnitsMoMo" values are not null
  ...
  Scenario: NumberOfUnitsTotal
    ...
    And "NumberOfUnitsTotal" values are not null
  ...
  Scenario: NumberOfUnitsVacant
    ...
    And "NumberOfUnitsVacant" values are not null
  ...
  Scenario: PhotosCount
    ...
    And "PhotosCount" values are not null
  ...
  Scenario: RoomsTotal
    ...
    And "RoomsTotal" values are not null
  ...
  Scenario: SeatingCapacity
    ...
    And "SeatingCapacity" values are not null
  ...
  Scenario: Stories
    ...
    And "Stories" values are not null
  ...
  Scenario: StoriesTotal
    ...
    And "StoriesTotal" values are not null
  ...
  Scenario: StreetNumberNumeric
    ...
    And "StreetNumberNumeric" values are not null
  ...
  Scenario: TaxAssessedValue
    ...
    And "TaxAssessedValue" values are not null
  ...
  Scenario: TaxYear
    ...
    And "TaxYear" values are not null
  ...
  Scenario: VacancyAllowance
    ...
    And "VacancyAllowance" values are not null
  ...
  Scenario: VideosCount
    ...
    And "VideosCount" values are not null
  ...
  Scenario: WalkScore
    ...
    And "WalkScore" values are not null
  ...
  Scenario: YearBuilt
    ...
    And "YearBuilt" values are not null
  ...
  Scenario: YearBuiltEffective
    ...
    And "YearBuiltEffective" values are not null
  ...
  Scenario: YearEstablished
    ...
    And "YearEstablished" values are not null
  ...
  Scenario: YearsCurrentOwner
    ...
    And "YearsCurrentOwner" values are not null
