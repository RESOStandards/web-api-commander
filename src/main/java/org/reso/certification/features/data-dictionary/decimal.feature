Feature: Decimal Testing
  ...
  Scenario: AboveGradeFinishedArea
    ...
    And "AboveGradeFinishedArea" values are not null
  ...
  Scenario: AssociationFee
    ...
    And "AssociationFee" values are not null
  ...
  Scenario: AssociationFee2
    ...
    And "AssociationFee2" values are not null
  ...
  Scenario: BelowGradeFinishedArea
    ...
    And "BelowGradeFinishedArea" values are not null
  ...
  Scenario: BuildingAreaTotal
    ...
    And "BuildingAreaTotal" values are not null
  ...
  Scenario: CableTvExpense
    ...
    And "CableTvExpense" values are not null
  ...
  Scenario: CapRate
    ...
    And "CapRate" values are not null
  ...
  Scenario: CarportSpaces
    ...
    And "CarportSpaces" values are not null
  ...
  Scenario: ClosePrice
    ...
    And "ClosePrice" values are not null
  ...
  Scenario: CoveredSpaces
    ...
    And "CoveredSpaces" values are not null
  ...
  Scenario: CultivatedArea
    ...
    And "CultivatedArea" values are not null
  ...
  Scenario: ElectricExpense
    ...
    And "ElectricExpense" values are not null
  ...
  Scenario: FoundationArea
    ...
    And "FoundationArea" values are not null
  ...
  Scenario: FuelExpense
    ...
    And "FuelExpense" values are not null
  ...
  Scenario: FurnitureReplacementExpense
    ...
    And "FurnitureReplacementExpense" values are not null
  ...
  Scenario: GarageSpaces
    ...
    And "GarageSpaces" values are not null
  ...
  Scenario: GardnerExpense
    ...
    And "GardnerExpense" values are not null
  ...
  Scenario: GardenerExpense
    ...
    And "GardenerExpense" values are not null
  ...
  Scenario: GrossIncome
    ...
    And "GrossIncome" values are not null
  ...
  Scenario: GrossScheduledIncome
    ...
    And "GrossScheduledIncome" values are not null
  ...
  Scenario: InsuranceExpense
    ...
    And "InsuranceExpense" values are not null
  ...
  Scenario: LandLeaseAmount
    ...
    And "LandLeaseAmount" values are not null
  ...
  Scenario: LeasableArea
    ...
    And "LeasableArea" values are not null
  ...
  Scenario: LeaseAmount
    ...
    And "LeaseAmount" values are not null
  ...
  Scenario: LicensesExpense
    ...
    And "LicensesExpense" values are not null
  ...
  Scenario: ListPriceLow
    ...
    And "ListPriceLow" values are not null
  ...
  Scenario: LivingArea
    ...
    And "LivingArea" values are not null
  ...
  Scenario: LotSizeSquareFeet
    ...
    And "LotSizeSquareFeet" values are not null
  ...
  Scenario: MaintenanceExpense
    ...
    And "MaintenanceExpense" values are not null
  ...
  Scenario: ManagerExpense
    ...
    And "ManagerExpense" values are not null
  ...
  Scenario: NetOperatingIncome
    ...
    And "NetOperatingIncome" values are not null
  ...
  Scenario: NewTaxesExpense
    ...
    And "NewTaxesExpense" values are not null
  ...
  Scenario: OpenParkingSpaces
    ...
    And "OpenParkingSpaces" values are not null
  ...
  Scenario: OperatingExpense
    ...
    And "OperatingExpense" values are not null
  ...
  Scenario: OriginalListPrice
    ...
    And "OriginalListPrice" values are not null
  ...
  Scenario: OtherExpense
    ...
    And "OtherExpense" values are not null
  ...
  Scenario: ParkingTotal
    ...
    And "ParkingTotal" values are not null
  ...
  Scenario: PastureArea
    ...
    And "PastureArea" values are not null
  ...
  Scenario: PestControlExpense
    ...
    And "PestControlExpense" values are not null
  ...
  Scenario: PoolExpense
    ...
    And "PoolExpense" values are not null
  ...
  Scenario: PreviousListPrice
    ...
    And "PreviousListPrice" values are not null
  ...
  Scenario: ProfessionalManagementExpense
    ...
    And "ProfessionalManagementExpense" values are not null
  ...
  Scenario: RangeArea
    ...
    And "RangeArea" values are not null
  ...
  Scenario: TaxAnnualAmount
    ...
    And "TaxAnnualAmount" values are not null
  ...
  Scenario: TaxOtherAnnualAssessmentAmount
    ...
    And "TaxOtherAnnualAssessmentAmount" values are not null
  ...
  Scenario: TotalActualRent
    ...
    And "TotalActualRent" values are not null
  ...
  Scenario: TrashExpense
    ...
    And "TrashExpense" values are not null
  ...
  Scenario: VacancyAllowanceRate
    ...
    And "VacancyAllowanceRate" values are not null
  ...
  Scenario: WaterSewerExpense
    ...
    And "WaterSewerExpense" values are not null
  ...
  Scenario: WoodedArea
    ...
    And "WoodedArea" values are not null
  ...
  Scenario: WorkmansCompensationExpense
    ...
    And "WorkmansCompensationExpense" values are not null
  ...
  Scenario: IrrigationWaterRightsAcres
    ...
    And "IrrigationWaterRightsAcres" values are not null
  ...
  Scenario: LotSizeAcres
    ...
    And "LotSizeAcres" values are not null
  ...
  Scenario: LotSizeArea
    ...
    And "LotSizeArea" values are not null
  ...
  Scenario: Latitude
    ...
    And "Latitude" values are not null
  ...
  Scenario: Longitude
    ...
    And "Longitude" values are not null
