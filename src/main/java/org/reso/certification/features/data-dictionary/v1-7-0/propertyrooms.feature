...
Feature: PropertyRooms
  ...
  Scenario: RoomAreaSource
    ...
    Then "RoomAreaSource" is defined as a single-valued enumeration
    And "RoomAreaSource" standard enumeration values exist in the metadata

  @RoomAreaUnits @PropertyRooms
  Scenario: RoomAreaUnits
    When "RoomAreaUnits" exists in the "PropertyRooms" metadata
    Then "RoomAreaUnits" is defined as a single-valued enumeration
    And "RoomAreaUnits" standard enumeration values exist in the metadata
  ...
  Scenario: RoomFeatures
    ...
    Then "RoomFeatures" is defined as a multi-valued enumeration
    And "RoomFeatures" standard enumeration values exist in the metadata
  ...
  Scenario: RoomLengthWidthUnits
    ...
    Then "RoomLengthWidthUnits" is defined as a single-valued enumeration
    And "RoomLengthWidthUnits" standard enumeration values exist in the metadata

  @RoomType @PropertyRooms
  Scenario: RoomType
    When "RoomType" exists in the "PropertyRooms" metadata
    Then "RoomType" is defined as a single-valued enumeration
