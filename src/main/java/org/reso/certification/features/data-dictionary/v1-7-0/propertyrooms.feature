...
Feature: PropertyRooms
  ...
  Scenario: RoomAreaSource
    ...
    And "RoomAreaSource" enum types MUST allow only one member
  ...
  Scenario: RoomAreaUnits
    ...
    And "RoomAreaUnits" enum types MUST allow only one member
  ...
  Scenario: RoomLengthWidthSource
    ...
    And "RoomLengthWidthSource" enum types MUST allow only one member
  ...
  Scenario: RoomLengthWidthUnits
    ...
    And "RoomLengthWidthUnits" enum types MUST allow only one member
  ...
  Scenario: RoomLevel
    ...
    And "RoomLevel" enum types MUST allow only one member
  ...
  Scenario: RoomType
    ...
    And "RoomType" enum types MUST allow only one member
