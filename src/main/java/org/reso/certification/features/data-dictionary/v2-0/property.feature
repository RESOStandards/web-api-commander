...
Feature: Property
  ...
  Scenario: AboveGradeUnfinishedArea
    ...
    Then "AboveGradeUnfinishedArea" MUST be "Integer" data type
  ...
  Scenario: BelowGradeUnfinishedArea
    ...
    Then "BelowGradeUnfinishedArea" MUST be "Integer" data type
  ...
  Scenario: PropertyTimeZoneStandardOffset
    ...
    Then "PropertyTimeZoneStandardOffset" MUST be "String" data type
    And "PropertyTimeZoneStandardOffset" length SHOULD be equal to the RESO Suggested Max Length of 10

  @Property @dd-2.0
  Scenario: TaxAnnualAmountPerLivingAreaUnit
    When "TaxAnnualAmountPerLivingAreaUnit" exists in the "Property" metadata
    Then "TaxAnnualAmountPerLivingAreaUnit" MUST be "Integer" data type
