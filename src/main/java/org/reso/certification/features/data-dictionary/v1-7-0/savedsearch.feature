...
Feature: SavedSearch
  ...
  Scenario: SavedSearchType
    ...
    Then "SavedSearchType" is defined as a single-valued enumeration
    And "SavedSearchType" standard enumeration values exist in the metadata
  ...
  Scenario: SearchQueryExceptions
    ...
    Then "SearchQueryExceptions" is defined as a single-valued enumeration
    And "SearchQueryExceptions" standard enumeration values exist in the metadata
  ...
  Scenario: SearchQueryType
    ...
    Then "SearchQueryType" is defined as a single-valued enumeration
    And "SearchQueryType" standard enumeration values exist in the metadata
