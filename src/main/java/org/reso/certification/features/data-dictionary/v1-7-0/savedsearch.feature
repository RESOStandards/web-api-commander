...
Feature: SavedSearch
  ...
  Scenario: SavedSearchType
    ...
    And "SavedSearchType" enum types MUST allow only one member
  ...
  Scenario: SearchQueryExceptions
    ...
    And "SearchQueryExceptions" enum types MUST allow only one member
  ...
  Scenario: SearchQueryType
    ...
    And "SearchQueryType" enum types MUST allow only one member
