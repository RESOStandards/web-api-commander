...
Feature: Property
  ...
  Scenario: AboveGradeFinishedArea
    ...
    And "AboveGradeFinishedArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: AboveGradeFinishedAreaSource
    ...
    And "AboveGradeFinishedAreaSource" MAY contain any of the standard lookups
  ...
  Scenario: AboveGradeFinishedAreaUnits
    ...
    And "AboveGradeFinishedAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: AccessibilityFeatures
    ...
    And "AccessibilityFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Appliances
    ...
    And "Appliances" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: AssociationAmenities
    ...
    And "AssociationAmenities" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: AssociationFee
    ...
    And "AssociationFee" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: AssociationFee2
    ...
    And "AssociationFee2" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: AssociationFee2Frequency
    ...
    And "AssociationFee2Frequency" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Annually | Annually |
  ...
  Scenario: AssociationFeeFrequency
    ...
    And "AssociationFeeFrequency" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Annually | Annually |
      | BiMonthly | Bi-Monthly |
      | BiWeekly | Bi-Weekly |
  ...
  Scenario: AssociationFeeIncludes
    ...
    And "AssociationFeeIncludes" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | CableTv | Cable TV |
  ...
  Scenario: Basement
    ...
    And "Basement" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Apartment | Apartment |
  ...
  Scenario: BelowGradeFinishedArea
    ...
    And "BelowGradeFinishedArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: BelowGradeFinishedAreaSource
    ...
    And "BelowGradeFinishedAreaSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: BelowGradeFinishedAreaUnits
    ...
    And "BelowGradeFinishedAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: BodyType
    ...
    And "BodyType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: BuildingAreaSource
    ...
    And "BuildingAreaSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: BuildingAreaTotal
    ...
    And "BuildingAreaTotal" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: BuildingAreaUnits
    ...
    And "BuildingAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: BusinessType
    ...
    And "BusinessType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: BuyerAgencyCompensationType
    ...
    And "BuyerAgencyCompensationType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Dollars | $ |
      | Other | Other |
      | Percent | % |
  ...
  Scenario: BuyerAgentDesignation
    ...
    And "BuyerAgentDesignation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: BuyerFinancing
    ...
    And "BuyerFinancing" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Assumed | Assumed |
      | Cash | Cash |
      | Contract | Contract |
  ...
  Scenario: CableTvExpense
    ...
    And "CableTvExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: CapRate
    ...
    And "CapRate" precision SHOULD be equal to the RESO Suggested Max Length of 5
  ...
  Scenario: CarportSpaces
    ...
    And "CarportSpaces" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ClosePrice
    ...
    And "ClosePrice" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: CoBuyerAgentDesignation
    ...
    And "CoBuyerAgentDesignation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AccreditedBuyersRepresentative | Accredited Buyer's Representative / ABR |
      | AccreditedLandConsultant | Accredited Land Consultant / ALC |
      | AtHomeWithDiversity | At Home With Diversity / AHWD |
  ...
  Scenario: CoListAgentDesignation
    ...
    And "CoListAgentDesignation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AccreditedBuyersRepresentative | Accredited Buyer's Representative / ABR |
      | AccreditedLandConsultant | Accredited Land Consultant / ALC |
      | AtHomeWithDiversity | At Home With Diversity / AHWD |
  ...
  Scenario: CommonInterest
    ...
    And "CommonInterest" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: CommonWalls
    ...
    And "CommonWalls" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | EndUnit | End Unit |
  ...
  Scenario: CommunityFeatures
    ...
    And "CommunityFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AirportRunway | Airport/Runway |
      | Clubhouse | Clubhouse |
      | Curbs | Curbs |
  ...
  Scenario: Concessions
    ...
    And "Concessions" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ConstructionMaterials
    ...
    And "ConstructionMaterials" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Adobe | Adobe |
  ...
  Scenario: Cooling
    ...
    And "Cooling" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AtticFan | Attic Fan |
  ...
  Scenario: Country
    ...
    And "Country" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AD | AD |
      | AE | AE |
      | AF | AF |
  ...
  Scenario: CoveredSpaces
    ...
    And "CoveredSpaces" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: CultivatedArea
    ...
    And "CultivatedArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: CurrentFinancing
    ...
    And "CurrentFinancing" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Assumable | Assumable |
      | Contract | Contract |
      | Conventional | Conventional |
  ...
  Scenario: CurrentUse
    ...
    And "CurrentUse" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: DevelopmentStatus
    ...
    And "DevelopmentStatus" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Completed | Completed |
  ...
  Scenario: DirectionFaces
    ...
    And "DirectionFaces" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | East | East |
      | North | North |
      | Northeast | Northeast |
  ...
  Scenario: DistanceToBusUnits
    ...
    And "DistanceToBusUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToElectricUnits
    ...
    And "DistanceToElectricUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToFreewayUnits
    ...
    And "DistanceToFreewayUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToGasUnits
    ...
    And "DistanceToGasUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToPhoneServiceUnits
    ...
    And "DistanceToPhoneServiceUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToPlaceofWorshipUnits
    ...
    And "DistanceToPlaceofWorshipUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToSchoolBusUnits
    ...
    And "DistanceToSchoolBusUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToSchoolsUnits
    ...
    And "DistanceToSchoolsUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToSewerUnits
    ...
    And "DistanceToSewerUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToShoppingUnits
    ...
    And "DistanceToShoppingUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToStreetUnits
    ...
    And "DistanceToStreetUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DistanceToWaterUnits
    ...
    And "DistanceToWaterUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: DoorFeatures
    ...
    And "DoorFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Electric
    ...
    And "Electric" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ElectricExpense
    ...
    And "ElectricExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ElevationUnits
    ...
    And "ElevationUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: ExistingLeaseType
    ...
    And "ExistingLeaseType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ExteriorFeatures
    ...
    And "ExteriorFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Awnings | Awning(s) |
      | Balcony | Balcony |
      | Barbecue | Barbecue |
  ...
  Scenario: FarmLandAreaSource
    ...
    And "FarmLandAreaSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: FarmLandAreaUnits
    ...
    And "FarmLandAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: Fencing
    ...
    And "Fencing" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | BackYard | Back Yard |
  ...
  Scenario: FinancialDataSource
    ...
    And "FinancialDataSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: FireplaceFeatures
    ...
    And "FireplaceFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Basement | Basement |
      | Bath | Bath |
      | Bedroom | Bedroom |
  ...
  Scenario: Flooring
    ...
    And "Flooring" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Adobe | Adobe |
      | Bamboo | Bamboo |
      | Brick | Brick |
  ...
  Scenario: FoundationArea
    ...
    And "FoundationArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: FoundationDetails
    ...
    And "FoundationDetails" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Block | Block |
  ...
  Scenario: FrontageType
    ...
    And "FrontageType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: FuelExpense
    ...
    And "FuelExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: Furnished
    ...
    And "Furnished" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Furnished | Furnished |
  ...
  Scenario: FurnitureReplacementExpense
    ...
    And "FurnitureReplacementExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: GarageSpaces
    ...
    And "GarageSpaces" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: GardenerExpense
    ...
    And "GardenerExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: GreenEnergyEfficient
    ...
    And "GreenEnergyEfficient" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appliances | Appliances |
  ...
  Scenario: GreenEnergyGeneration
    ...
    And "GreenEnergyGeneration" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Solar | Solar |
      | Wind | Wind |
  ...
  Scenario: GreenIndoorAirQuality
    ...
    And "GreenIndoorAirQuality" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: GreenSustainability
    ...
    And "GreenSustainability" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: GreenWaterConservation
    ...
    And "GreenWaterConservation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: GrossIncome
    ...
    And "GrossIncome" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: GrossScheduledIncome
    ...
    And "GrossScheduledIncome" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: Heating
    ...
    And "Heating" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: HorseAmenities
    ...
    And "HorseAmenities" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Arena | Arena |
      | Barn | Barn |
  ...
  Scenario: HoursDaysOfOperation
    ...
    And "HoursDaysOfOperation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: IncomeIncludes
    ...
    And "IncomeIncludes" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Laundry | Laundry |
      | Parking | Parking |
      | Recreation | Recreation |
  ...
  Scenario: InsuranceExpense
    ...
    And "InsuranceExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: InteriorFeatures
    ...
    And "InteriorFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Bar | Bar |
  ...
  Scenario: IrrigationWaterRightsAcres
    ...
    And "IrrigationWaterRightsAcres" precision SHOULD be equal to the RESO Suggested Max Length of 16
  ...
  Scenario: LaborInformation
    ...
    And "LaborInformation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: LandLeaseAmount
    ...
    And "LandLeaseAmount" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: LandLeaseAmountFrequency
    ...
    And "LandLeaseAmountFrequency" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Annually | Annually |
      | BiMonthly | Bi-Monthly |
      | BiWeekly | Bi-Weekly |
  ...
  Scenario: Latitude
    ...
    And "Latitude" precision SHOULD be equal to the RESO Suggested Max Length of 12
  ...
  Scenario: LaundryFeatures
    ...
    And "LaundryFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | CommonArea | Common Area |
  ...
  Scenario: LeasableArea
    ...
    And "LeasableArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: LeasableAreaUnits
    ...
    And "LeasableAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: LeaseAmount
    ...
    And "LeaseAmount" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: LeaseAmountFrequency
    ...
    And "LeaseAmountFrequency" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Annually | Annually |
      | BiMonthly | Bi-Monthly |
      | BiWeekly | Bi-Weekly |
  ...
  Scenario: LeaseRenewalCompensation
    ...
    And "LeaseRenewalCompensation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | CallListingAgent | Call Listing Agent |
  ...
  Scenario: LeaseTerm
    ...
    And "LeaseTerm" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Levels
    ...
    And "Levels" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: LicensesExpense
    ...
    And "LicensesExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ListAgentDesignation
    ...
    And "ListAgentDesignation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AccreditedBuyersRepresentative | Accredited Buyer's Representative / ABR |
      | AccreditedLandConsultant | Accredited Land Consultant / ALC |
      | AtHomeWithDiversity | At Home With Diversity / AHWD |
  ...
  Scenario: ListPrice
    ...
    And "ListPrice" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ListPriceLow
    ...
    And "ListPriceLow" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ListingAgreement
    ...
    And "ListingAgreement" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ListingService
    ...
    And "ListingService" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ListingTerms
    ...
    And "ListingTerms" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: LivingArea
    ...
    And "LivingArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: LivingAreaSource
    ...
    And "LivingAreaSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: LivingAreaUnits
    ...
    And "LivingAreaUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: LockBoxType
    ...
    And "LockBoxType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | CallListingOffice | Call Listing Office |
  ...
  Scenario: Longitude
    ...
    And "Longitude" precision SHOULD be equal to the RESO Suggested Max Length of 12
  ...
  Scenario: LotDimensionsSource
    ...
    And "LotDimensionsSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: LotFeatures
    ...
    And "LotFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agricultural | Agricultural |
      | BackYard | Back Yard |
      | Bluff | Bluff |
  ...
  Scenario: LotSizeAcres
    ...
    And "LotSizeAcres" precision SHOULD be equal to the RESO Suggested Max Length of 16
  ...
  Scenario: LotSizeArea
    ...
    And "LotSizeArea" precision SHOULD be equal to the RESO Suggested Max Length of 16
  ...
  Scenario: LotSizeSource
    ...
    And "LotSizeSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
  ...
  Scenario: LotSizeSquareFeet
    ...
    And "LotSizeSquareFeet" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: LotSizeUnits
    ...
    And "LotSizeUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Acres | Acres |
      | SquareFeet | Square Feet |
      | SquareMeters | Square Meters |
  ...
  Scenario: MaintenanceExpense
    ...
    And "MaintenanceExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: MajorChangeType
    ...
    And "MajorChangeType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Active | Active |
  ...
  Scenario: ManagerExpense
    ...
    And "ManagerExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: MobileDimUnits
    ...
    And "MobileDimUnits" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Feet | Feet |
      | Meters | Meters |
  ...
  Scenario: NetOperatingIncome
    ...
    And "NetOperatingIncome" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: NewTaxesExpense
    ...
    And "NewTaxesExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: OccupantType
    ...
    And "OccupantType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Owner | Owner |
      | Tenant | Tenant |
      | Vacant | Vacant |
  ...
  Scenario: OpenParkingSpaces
    ...
    And "OpenParkingSpaces" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: OperatingExpense
    ...
    And "OperatingExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: OperatingExpenseIncludes
    ...
    And "OperatingExpenseIncludes" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Accounting | Accounting |
      | Advertising | Advertising |
  ...
  Scenario: OriginalListPrice
    ...
    And "OriginalListPrice" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: OtherEquipment
    ...
    And "OtherEquipment" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: OtherExpense
    ...
    And "OtherExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: OtherStructures
    ...
    And "OtherStructures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: OwnerPays
    ...
    And "OwnerPays" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: OwnershipType
    ...
    And "OwnershipType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ParkingFeatures
    ...
    And "ParkingFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ParkingTotal
    ...
    And "ParkingTotal" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: PastureArea
    ...
    And "PastureArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: PatioAndPorchFeatures
    ...
    And "PatioAndPorchFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Awnings | Awning(s) |
      | Covered | Covered |
      | Deck | Deck |
  ...
  Scenario: PestControlExpense
    ...
    And "PestControlExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: PetsAllowed
    ...
    And "PetsAllowed" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: PoolExpense
    ...
    And "PoolExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: PoolFeatures
    ...
    And "PoolFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Possession
    ...
    And "Possession" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: PossibleUse
    ...
    And "PossibleUse" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agricultural | Agricultural |
      | Cattle | Cattle |
      | Commercial | Commercial |
  ...
  Scenario: PowerProductionType
    ...
    And "PowerProductionType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: PreviousListPrice
    ...
    And "PreviousListPrice" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: ProfessionalManagementExpense
    ...
    And "ProfessionalManagementExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: PropertyCondition
    ...
    And "PropertyCondition" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Fixer | Fixer |
  ...
  Scenario: PropertySubType
    ...
    And "PropertySubType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agriculture | Agriculture |
      | Apartment | Apartment |
      | BoatSlip | Boat Slip |
  ...
  Scenario: PropertyType
    ...
    And "PropertyType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: RangeArea
    ...
    And "RangeArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: RentIncludes
    ...
    And "RentIncludes" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AllUtilities | All Utilities |
      | CableTv | Cable TV |
      | Electricity | Electricity |
  ...
  Scenario: RoadFrontageType
    ...
    And "RoadFrontageType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Alley | Alley |
  ...
  Scenario: RoadResponsibility
    ...
    And "RoadResponsibility" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: RoadSurfaceType
    ...
    And "RoadSurfaceType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Roof
    ...
    And "Roof" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Aluminum | Aluminum |
  ...
  Scenario: SecurityFeatures
    ...
    And "SecurityFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Sewer
    ...
    And "Sewer" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ShowingContactType
    ...
    And "ShowingContactType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agent | Agent |
      | Occupant | Occupant |
      | Owner | Owner |
  ...
  Scenario: ShowingRequirements
    ...
    And "ShowingRequirements" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: Skirt
    ...
    And "Skirt" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Aluminum | Aluminum |
      | Block | Block |
      | Brick | Brick |
  ...
  Scenario: SpaFeatures
    ...
    And "SpaFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AboveGround | Above Ground |
      | Bath | Bath |
      | Community | Community |
  ...
  Scenario: SpecialLicenses
    ...
    And "SpecialLicenses" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | BeerWine | Beer/Wine |
      | ClassH | Class H |
  ...
  Scenario: SpecialListingConditions
    ...
    And "SpecialListingConditions" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Auction | Auction |
  ...
  Scenario: StateOrProvince
    ...
    And "StateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: StreetDirPrefix
    ...
    And "StreetDirPrefix" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | E | E |
      | N | N |
      | NE | NE |
  ...
  Scenario: StreetDirSuffix
    ...
    And "StreetDirSuffix" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | E | E |
      | N | N |
      | NE | NE |
  ...
  Scenario: StructureType
    ...
    And "StructureType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Cabin | Cabin |
      | Dock | Dock |
      | Duplex | Duplex |
  ...
  Scenario: SubAgencyCompensationType
    ...
    And "SubAgencyCompensationType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Dollars | $ |
      | Other | Other |
      | Percent | % |
  ...
  Scenario: SuppliesExpense
    ...
    And "SuppliesExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: TaxAnnualAmount
    ...
    And "TaxAnnualAmount" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: TaxOtherAnnualAssessmentAmount
    ...
    And "TaxOtherAnnualAssessmentAmount" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: TaxStatusCurrent
    ...
    And "TaxStatusCurrent" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Personal | Personal |
  ...
  Scenario: TenantPays
    ...
    And "TenantPays" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AllUtilities | All Utilities |
      | AssociationFees | Association Fees |
      | CableTv | Cable TV |
  ...
  Scenario: TotalActualRent
    ...
    And "TotalActualRent" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: TransactionBrokerCompensationType
    ...
    And "TransactionBrokerCompensationType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Dollars | $ |
      | Other | Other |
      | Percent | % |
  ...
  Scenario: TrashExpense
    ...
    And "TrashExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: UnitsFurnished
    ...
    And "UnitsFurnished" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AllUnits | All Units |
      | None | None |
      | VariesByUnit | Varies By Unit |
  ...
  Scenario: Utilities
    ...
    And "Utilities" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: VacancyAllowanceRate
    ...
    And "VacancyAllowanceRate" precision SHOULD be equal to the RESO Suggested Max Length of 5
  ...
  Scenario: Vegetation
    ...
    And "Vegetation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Brush | Brush |
      | Cleared | Cleared |
      | Crops | Crop(s) |
  ...
  Scenario: View
    ...
    And "View" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Bay | Bay |
      | Beach | Beach |
      | Bridges | Bridge(s) |
  ...
  Scenario: WaterSewerExpense
    ...
    And "WaterSewerExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: WaterSource
    ...
    And "WaterSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Cistern | Cistern |
      | None | None |
      | Other | Other |
  ...
  Scenario: WaterfrontFeatures
    ...
    And "WaterfrontFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | BeachAccess | Beach Access |
  ...
  Scenario: WindowFeatures
    ...
    And "WindowFeatures" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: WoodedArea
    ...
    And "WoodedArea" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: WorkmansCompensationExpense
    ...
    And "WorkmansCompensationExpense" precision SHOULD be equal to the RESO Suggested Max Length of 14
  ...
  Scenario: YearBuiltSource
    ...
    And "YearBuiltSource" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Appraiser | Appraiser |
      | Assessor | Assessor |
      | Builder | Builder |
