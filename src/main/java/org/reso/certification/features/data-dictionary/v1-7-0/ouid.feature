...
Feature: OUID
  ...
  Scenario: OrganizationAOR
    ...
    And "OrganizationAOR" enum types MUST allow only one member
  ...
  Scenario: OrganizationCountry
    ...
    And "OrganizationCountry" enum types MUST allow only one member
  ...
  Scenario: OrganizationCountyOrParish
    ...
    And "OrganizationCountyOrParish" enum types MUST allow only one member
  ...
  Scenario: OrganizationSocialMediaType
    ...
    And "OrganizationSocialMediaType" enum types MUST allow only one member
  ...
  Scenario: OrganizationStateLicenseState
    ...
    And "OrganizationStateLicenseState" enum types MUST allow only one member
  ...
  Scenario: OrganizationStateOrProvince
    ...
    And "OrganizationStateOrProvince" enum types MUST allow only one member
  ...
  Scenario: OrganizationType
    ...
    And "OrganizationType" enum types MUST allow only one member
