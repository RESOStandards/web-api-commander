...
Feature: Contacts
  ...
  Scenario: ContactStatus
    ...
    Then "ContactStatus" is defined as a single-valued enumeration
    And "ContactStatus" standard enumeration values exist in the metadata

  @ContactType @Contacts
  Scenario: ContactType
    When "ContactType" exists in the "Contacts" metadata
    Then "ContactType" is defined as a multi-valued enumeration
    And "ContactType" standard enumeration values exist in the metadata
  ...
  Scenario: HomeCountry
    ...
    Then "HomeCountry" is defined as a single-valued enumeration
    And "HomeCountry" standard enumeration values exist in the metadata

  @HomeCountyOrParish @Contacts
  Scenario: HomeCountyOrParish
    When "HomeCountyOrParish" exists in the "Contacts" metadata
    Then "HomeCountyOrParish" is defined as a single-valued enumeration
    And "HomeCountyOrParish" standard enumeration values exist in the metadata
  ...
  Scenario: HomeStateOrProvince
    ...
    Then "HomeStateOrProvince" is defined as a single-valued enumeration
    And "HomeStateOrProvince" standard enumeration values exist in the metadata
  ...
  Scenario: Language
    ...
    Then "Language" is defined as a multi-valued enumeration
    And "Language" standard enumeration values exist in the metadata
  ...
  Scenario: OtherCountry
    ...
    Then "OtherCountry" is defined as a single-valued enumeration
    And "OtherCountry" standard enumeration values exist in the metadata

  @OtherCountyOrParish @Contacts
  Scenario: OtherCountyOrParish
    When "OtherCountyOrParish" exists in the "Contacts" metadata
    Then "OtherCountyOrParish" is defined as a single-valued enumeration
    And "OtherCountyOrParish" standard enumeration values exist in the metadata
  ...
  Scenario: OtherStateOrProvince
    ...
    Then "OtherStateOrProvince" is defined as a single-valued enumeration
    And "OtherStateOrProvince" standard enumeration values exist in the metadata
  ...
  Scenario: PreferredAddress
    ...
    Then "PreferredAddress" is defined as a single-valued enumeration
    And "PreferredAddress" standard enumeration values exist in the metadata

  @PreferredPhone @Contacts
  Scenario: PreferredPhone
    When "PreferredPhone" exists in the "Contacts" metadata
    Then "PreferredPhone" is defined as a single-valued enumeration
    And "PreferredPhone" standard enumeration values exist in the metadata
  ...
  Scenario: WorkCountry
    ...
    Then "WorkCountry" is defined as a single-valued enumeration
    And "WorkCountry" standard enumeration values exist in the metadata

  @WorkCountyOrParish @Contacts
  Scenario: WorkCountyOrParish
    When "WorkCountyOrParish" exists in the "Contacts" metadata
    Then "WorkCountyOrParish" is defined as a single-valued enumeration
    And "WorkCountyOrParish" standard enumeration values exist in the metadata
  ...
  Scenario: WorkStateOrProvince
    ...
    Then "WorkStateOrProvince" is defined as a single-valued enumeration
    And "WorkStateOrProvince" standard enumeration values exist in the metadata
