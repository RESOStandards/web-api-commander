...
Feature: Contacts
  ...
  Scenario: ContactStatus
    ...
    And "ContactStatus" MAY contain any of the standard lookups
  ...
  Scenario: ContactType
    ...
    And "ContactType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Business | Business |
      | Family | Family |
      | Friend | Friend |
  ...
  Scenario: HomeCountry
    ...
    And "HomeCountry" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AD | AD |
      | AE | AE |
      | AF | AF |
  ...
  Scenario: HomeStateOrProvince
    ...
    And "HomeStateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: Language
    ...
    And "Language" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Abkhazian | Abkhazian |
      | Afar | Afar |
      | Afrikaans | Afrikaans |
  ...
  Scenario: OtherCountry
    ...
    And "OtherCountry" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AD | AD |
      | AE | AE |
      | AF | AF |
  ...
  Scenario: OtherStateOrProvince
    ...
    And "OtherStateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: PreferredAddress
    ...
    And "PreferredAddress" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Home | Home |
      | Other | Other |
      | Work | Work |
  ...
  Scenario: PreferredPhone
    ...
    And "PreferredPhone" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Direct | Direct |
      | Home | Home |
      | Mobile | Mobile |
  ...
  Scenario: WorkCountry
    ...
    And "WorkCountry" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AD | AD |
      | AE | AE |
      | AF | AF |
  ...
  Scenario: WorkStateOrProvince
    ...
    And "WorkStateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
