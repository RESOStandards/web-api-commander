...
Feature: Contacts
  ...
  Scenario: Anniversary
    Given "Anniversary" exists in the "Contacts" metadata
  ...
  Scenario: AssistantEmail
    Given "AssistantEmail" exists in the "Contacts" metadata
  ...
  Scenario: AssistantName
    Given "AssistantName" exists in the "Contacts" metadata
  ...
  Scenario: AssistantPhone
    Given "AssistantPhone" exists in the "Contacts" metadata
  ...
  Scenario: AssistantPhoneExt
    Given "AssistantPhoneExt" exists in the "Contacts" metadata
  ...
  @Birthdate @Contacts
  Scenario: Birthdate
    Given "Birthdate" exists in the "Contacts" metadata
  ...
  Scenario: BusinessFax
    Given "BusinessFax" exists in the "Contacts" metadata
  ...
  @Children @Contacts
  Scenario: Children
    Given "Children" exists in the "Contacts" metadata
  ...
  @Company @Contacts
  Scenario: Company
    Given "Company" exists in the "Contacts" metadata
  ...
  @ContactKey @Contacts
  Scenario: ContactKey
    Given "ContactKey" exists in the "Contacts" metadata
  ...
  Scenario: ContactKeyNumeric
    Given "ContactKeyNumeric" exists in the "Contacts" metadata
    Then "ContactKeyNumeric" MUST be "Integer" data type

  @ContactLoginId @Contacts
  Scenario: ContactLoginId
    Given "ContactLoginId" exists in the "Contacts" metadata
  ...
  Scenario: ContactPassword
    Given "ContactPassword" exists in the "Contacts" metadata
  ...
  Scenario: ContactStatus
    Given "ContactStatus" exists in the "Contacts" metadata
  ...
  Scenario: ContactType
    Given "ContactType" exists in the "Contacts" metadata
  ...
  @Department @Contacts
  Scenario: Department
    Given "Department" exists in the "Contacts" metadata
  ...
  Scenario: DirectPhone
    Given "DirectPhone" exists in the "Contacts" metadata
  ...
  @Email3 @Contacts
  Scenario: Email3
    Given "Email3" exists in the "Contacts" metadata
  ...
  @FirstName @Contacts
  Scenario: FirstName
    Given "FirstName" exists in the "Contacts" metadata
  ...
  @FullName @Contacts
  Scenario: FullName
    Given "FullName" exists in the "Contacts" metadata
  ...
  Scenario: HomeAddress1
    Given "HomeAddress1" exists in the "Contacts" metadata
  ...
  Scenario: HomeAddress2
    Given "HomeAddress2" exists in the "Contacts" metadata
  ...
  Scenario: HomeCarrierRoute
    Given "HomeCarrierRoute" exists in the "Contacts" metadata
  ...
  @HomeCity @Contacts
  Scenario: HomeCity
    Given "HomeCity" exists in the "Contacts" metadata
  ...
  Scenario: HomeCountry
    Given "HomeCountry" exists in the "Contacts" metadata
  ...
  Scenario: HomeCountyOrParish
    Given "HomeCountyOrParish" exists in the "Contacts" metadata
  ...
  @HomeFax @Contacts
  Scenario: HomeFax
    Given "HomeFax" exists in the "Contacts" metadata
  ...
  @HomePhone @Contacts
  Scenario: HomePhone
    Given "HomePhone" exists in the "Contacts" metadata
  ...
  Scenario: HomePostalCode
    Given "HomePostalCode" exists in the "Contacts" metadata
  ...
  Scenario: HomePostalCodePlus4
    Given "HomePostalCodePlus4" exists in the "Contacts" metadata
  ...
  Scenario: HomeStateOrProvince
    Given "HomeStateOrProvince" exists in the "Contacts" metadata
  ...
  @JobTitle @Contacts
  Scenario: JobTitle
    Given "JobTitle" exists in the "Contacts" metadata
  ...
  @Language @Contacts
  Scenario: Language
    Given "Language" exists in the "Contacts" metadata
  ...
  @LastName @Contacts
  Scenario: LastName
    Given "LastName" exists in the "Contacts" metadata
  ...
  @LeadSource @Contacts
  Scenario: LeadSource
    Given "LeadSource" exists in the "Contacts" metadata
  ...
  @MiddleName @Contacts
  Scenario: MiddleName
    Given "MiddleName" exists in the "Contacts" metadata
  ...
  Scenario: MobilePhone
    Given "MobilePhone" exists in the "Contacts" metadata
  ...
  @NameSuffix @Contacts
  Scenario: NameSuffix
    Given "NameSuffix" exists in the "Contacts" metadata
  ...
  @Nickname @Contacts
  Scenario: Nickname
    Given "Nickname" exists in the "Contacts" metadata
  ...
  @Notes @Contacts
  Scenario: Notes
    Given "Notes" exists in the "Contacts" metadata
  ...
  Scenario: OfficePhone
    Given "OfficePhone" exists in the "Contacts" metadata
  ...
  Scenario: OfficePhoneExt
    Given "OfficePhoneExt" exists in the "Contacts" metadata
  ...
  Scenario: OriginalEntryTimestamp
    Given "OriginalEntryTimestamp" exists in the "Contacts" metadata
  ...
  Scenario: OriginatingSystemContactKey
    Given "OriginatingSystemContactKey" exists in the "Contacts" metadata
  ...
  Scenario: OriginatingSystemID
    Given "OriginatingSystemID" exists in the "Contacts" metadata
  ...
  Scenario: OriginatingSystemName
    Given "OriginatingSystemName" exists in the "Contacts" metadata
  ...
  Scenario: OtherAddress1
    Given "OtherAddress1" exists in the "Contacts" metadata
  ...
  Scenario: OtherAddress2
    Given "OtherAddress2" exists in the "Contacts" metadata
  ...
  Scenario: OtherCarrierRoute
    Given "OtherCarrierRoute" exists in the "Contacts" metadata
  ...
  @OtherCity @Contacts
  Scenario: OtherCity
    Given "OtherCity" exists in the "Contacts" metadata
  ...
  Scenario: OtherCountry
    Given "OtherCountry" exists in the "Contacts" metadata
  ...
  Scenario: OtherCountyOrParish
    Given "OtherCountyOrParish" exists in the "Contacts" metadata
  ...
  Scenario: OtherPhoneType
    Given "OtherPhoneType" exists in the "Contacts" metadata
  ...
  Scenario: OtherPhone_TYPE_PLACEHOLDER_Ext
    Given "OtherPhone_TYPE_PLACEHOLDER_Ext" exists in the "Contacts" metadata
  ...
  Scenario: OtherPhone_TYPE_PLACEHOLDER_Number
    Given "OtherPhone_TYPE_PLACEHOLDER_Number" exists in the "Contacts" metadata
  ...
  Scenario: OtherPostalCode
    Given "OtherPostalCode" exists in the "Contacts" metadata
  ...
  Scenario: OtherPostalCodePlus4
    Given "OtherPostalCodePlus4" exists in the "Contacts" metadata
  ...
  Scenario: OtherStateOrProvince
    Given "OtherStateOrProvince" exists in the "Contacts" metadata
  ...
  Scenario: OwnerMemberID
    Given "OwnerMemberID" exists in the "Contacts" metadata
  ...
  Scenario: OwnerMemberKey
    Given "OwnerMemberKey" exists in the "Contacts" metadata
  ...
  Scenario: OwnerMemberKeyNumeric
    Given "OwnerMemberKeyNumeric" exists in the "Contacts" metadata
    Then "OwnerMemberKeyNumeric" MUST be "Integer" data type

  @Pager @Contacts
  Scenario: Pager
    Given "Pager" exists in the "Contacts" metadata
  ...
  Scenario: PhoneTTYTDD
    Given "PhoneTTYTDD" exists in the "Contacts" metadata
  ...
  Scenario: PreferredAddress
    Given "PreferredAddress" exists in the "Contacts" metadata
  ...
  Scenario: PreferredPhone
    Given "PreferredPhone" exists in the "Contacts" metadata
  ...
  @ReferredBy @Contacts
  Scenario: ReferredBy
    Given "ReferredBy" exists in the "Contacts" metadata
  ...
  Scenario: SocialMediaType
    Given "SocialMediaType" exists in the "Contacts" metadata
  ...
  Scenario: SocialMedia_TYPE_PLACEHOLDER_UrlOrId
    Given "SocialMedia_TYPE_PLACEHOLDER_UrlOrId" exists in the "Contacts" metadata
  ...
  Scenario: SourceSystemContactKey
    Given "SourceSystemContactKey" exists in the "Contacts" metadata
  ...
  Scenario: SourceSystemID
    Given "SourceSystemID" exists in the "Contacts" metadata
  ...
  Scenario: SourceSystemName
    Given "SourceSystemName" exists in the "Contacts" metadata
  ...
  Scenario: SpousePartnerName
    Given "SpousePartnerName" exists in the "Contacts" metadata
  ...
  Scenario: TollFreePhone
    Given "TollFreePhone" exists in the "Contacts" metadata
  ...
  Scenario: UserDefinedFieldName_NUM_PLACEHOLDER_
    Given "UserDefinedFieldName_NUM_PLACEHOLDER_" exists in the "Contacts" metadata
  ...
  Scenario: UserDefinedFieldValue_NUM_PLACEHOLDER_
    Given "UserDefinedFieldValue_NUM_PLACEHOLDER_" exists in the "Contacts" metadata
  ...
  @VoiceMail @Contacts
  Scenario: VoiceMail
    Given "VoiceMail" exists in the "Contacts" metadata
  ...
  Scenario: VoiceMailExt
    Given "VoiceMailExt" exists in the "Contacts" metadata
  ...
  Scenario: WorkAddress1
    Given "WorkAddress1" exists in the "Contacts" metadata
  ...
  Scenario: WorkAddress2
    Given "WorkAddress2" exists in the "Contacts" metadata
  ...
  Scenario: WorkCarrierRoute
    Given "WorkCarrierRoute" exists in the "Contacts" metadata
  ...
  @WorkCity @Contacts
  Scenario: WorkCity
    Given "WorkCity" exists in the "Contacts" metadata
  ...
  Scenario: WorkCountry
    Given "WorkCountry" exists in the "Contacts" metadata
  ...
  Scenario: WorkCountyOrParish
    Given "WorkCountyOrParish" exists in the "Contacts" metadata
  ...
  Scenario: WorkPostalCode
    Given "WorkPostalCode" exists in the "Contacts" metadata
  ...
  Scenario: WorkPostalCodePlus4
    Given "WorkPostalCodePlus4" exists in the "Contacts" metadata
  ...
  Scenario: WorkStateOrProvince
    Given "WorkStateOrProvince" exists in the "Contacts" metadata
