...
Feature: OpenHouse
  ...
  Scenario: OpenHouseAttendedBy
    ...
    And "OpenHouseAttendedBy" enum types MUST have at least one member
    ...
    And "OpenHouseAttendedBy" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: OpenHouseStatus
    ...
    And "OpenHouseStatus" enum types MUST have at least one member
    Then "OpenHouseStatus" MUST be "String" data type
    And "OpenHouseStatus" should only contain enum values found in the metadata
    And "OpenHouseStatus" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: OpenHouseType
    ...
    And "OpenHouseType" enum types MUST have at least one member
    Then "OpenHouseType" MUST be "String" data type
    And "OpenHouseType" should only contain enum values found in the metadata
    And "OpenHouseType" enumerations must match  MUST have annotations if they contain special characters
