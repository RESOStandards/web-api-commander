...
Feature: OpenHouse
  ...
  Scenario: OpenHouseAttendedBy
    ...
    And "OpenHouseAttendedBy" MAY contain any of the standard lookups
  ...
  Scenario: OpenHouseStatus
    ...
    And "OpenHouseStatus" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Active | Active |
      | Canceled | Canceled |
      | Ended | Ended |
  ...
  Scenario: OpenHouseType
    ...
    And "OpenHouseType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Broker | Broker |
      | Office | Office |
      | Public | Public |
