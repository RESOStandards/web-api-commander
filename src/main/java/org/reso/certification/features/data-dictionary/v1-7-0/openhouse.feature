...
Feature: OpenHouse
  ...
  Scenario: OpenHouseAttendedBy
    ...
    And "OpenHouseAttendedBy" enum types MUST allow only one member
  ...
  Scenario: OpenHouseStatus
    ...
    And "OpenHouseStatus" enum types MUST allow only one member
  ...
  Scenario: OpenHouseType
    ...
    And "OpenHouseType" enum types MUST allow only one member
