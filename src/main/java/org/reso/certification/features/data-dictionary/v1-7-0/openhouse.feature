...
Feature: OpenHouse
  ...
  Scenario: OpenHouseAttendedBy
    ...
    But "OpenHouseAttendedBy" MUST NOT contain any similar lookups
  ...
  Scenario: OpenHouseStatus
    ...
    And "OpenHouseStatus" MAY contain any of the following standard lookups
      ...
      | Canceled | Canceled |
      | Ended | Ended |
    But "OpenHouseStatus" MUST NOT contain any similar lookups
  ...
  Scenario: OpenHouseType
    ...
    And "OpenHouseType" MAY contain any of the following standard lookups
      ...
      | Office | Office |
      | Public | Public |
    But "OpenHouseType" MUST NOT contain any similar lookups
