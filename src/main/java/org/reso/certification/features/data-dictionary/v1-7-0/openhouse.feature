...
Feature: OpenHouse
  ...
  Scenario: OpenHouseAttendedBy
    ...
    Then "OpenHouseAttendedBy" is defined as a single-valued enumeration
    And "OpenHouseAttendedBy" standard enumeration values exist in the metadata
  ...
  Scenario: OpenHouseStatus
    ...
    Then "OpenHouseStatus" is defined as a single-valued enumeration
    And "OpenHouseStatus" standard enumeration values exist in the metadata

  @OpenHouseType @OpenHouse
  Scenario: OpenHouseType
    When "OpenHouseType" exists in the "OpenHouse" metadata
    Then "OpenHouseType" is defined as a single-valued enumeration
    And "OpenHouseType" standard enumeration values exist in the metadata
