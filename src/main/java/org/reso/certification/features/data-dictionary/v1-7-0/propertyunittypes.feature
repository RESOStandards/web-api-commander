...
Feature: PropertyUnitTypes
  ...
  Scenario: UnitTypeFurnished
    ...
    Then "UnitTypeFurnished" is defined as a single-valued enumeration
    And "UnitTypeFurnished" standard enumeration values exist in the metadata
  ...
  Scenario: UnitTypeType
    ...
    Then "UnitTypeType" is defined as a single-valued enumeration
