...
Feature: PropertyUnitTypes
  ...
  Scenario: ListingId
    Given "ListingId" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: ListingKey
    Given "ListingKey" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: ListingKeyNumeric
    Given "ListingKeyNumeric" exists in the "PropertyUnitTypes" metadata
    Then "ListingKeyNumeric" MUST be "Integer" data type

  @ModificationTimestamp @PropertyUnitTypes
  Scenario: ModificationTimestamp
    Given "ModificationTimestamp" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeActualRent
    Given "UnitTypeActualRent" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeFurnished
    Given "UnitTypeFurnished" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeGarageAttachedYN
    Given "UnitTypeGarageAttachedYN" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeGarageSpaces
    Given "UnitTypeGarageSpaces" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeKey
    Given "UnitTypeKey" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeType
    Given "UnitTypeType" exists in the "PropertyUnitTypes" metadata
  ...
  Scenario: UnitTypeUnitsTotal
    Given "UnitTypeUnitsTotal" exists in the "PropertyUnitTypes" metadata
