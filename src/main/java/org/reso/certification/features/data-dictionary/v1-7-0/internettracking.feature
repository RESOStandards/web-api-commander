...
Feature: InternetTracking
  ...
  Scenario: ActorStateOrProvince
    ...
    Then "ActorStateOrProvince" is defined as a single-valued enumeration
    And "ActorStateOrProvince" standard enumeration values exist in the metadata

  @ActorType @InternetTracking
  Scenario: ActorType
    When "ActorType" exists in the "InternetTracking" metadata
    Then "ActorType" is defined as a single-valued enumeration
    And "ActorType" standard enumeration values exist in the metadata
  ...
  Scenario: DeviceType
    ...
    Then "DeviceType" is defined as a single-valued enumeration
    And "DeviceType" standard enumeration values exist in the metadata
  ...
  Scenario: EventTarget
    ...
    Then "EventTarget" is defined as a single-valued enumeration
    And "EventTarget" standard enumeration values exist in the metadata
  ...
  Scenario: EventType
    ...
    Then "EventType" is defined as a single-valued enumeration
    And "EventType" standard enumeration values exist in the metadata
  ...
  Scenario: ObjectIdType
    ...
    Then "ObjectIdType" is defined as a single-valued enumeration
    And "ObjectIdType" standard enumeration values exist in the metadata
  ...
  Scenario: ObjectType
    ...
    Then "ObjectType" is defined as a single-valued enumeration
    And "ObjectType" standard enumeration values exist in the metadata
