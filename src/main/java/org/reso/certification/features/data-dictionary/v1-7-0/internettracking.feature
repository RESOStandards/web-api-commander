...
Feature: InternetTracking
  ...
  Scenario: ActorStateOrProvince
    ...
    And "ActorStateOrProvince" MAY contain any of the following standard lookups
      ...
      | WY | WY |
      | YT | YT |
    But "ActorStateOrProvince" MUST NOT contain any similar lookups

  @InternetTracking
  Scenario: ActorType
    When "ActorType" exists in the "InternetTracking" metadata
    Then "ActorType" MUST be "Single Enumeration" data type
    And "ActorType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Agent | Agent |
      | Bot | Bot |
      | Client | Client |
      | Consumer | Consumer |
      | Unknown | Unknown |
    But "ActorType" MUST NOT contain any similar lookups
  ...
  Scenario: DeviceType
    ...
    And "DeviceType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Desktop | Desktop |
      | Mobile | Mobile |
      | Tablet | Tablet |
      | Unknown | Unknown |
      | Wearable | Wearable |
    But "DeviceType" MUST NOT contain any similar lookups
  ...
  Scenario: EventTarget
    ...
    And "EventTarget" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Agent | Agent |
      | Broker | Broker |
      | Digg | Digg |
      ...
      | Twitter | Twitter |
      | Youtube | YouTube |
    But "EventTarget" MUST NOT contain any similar lookups
  ...
  Scenario: EventType
    ...
    And "EventType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | ClickedOnEmailAddress | Clicked on Email Address |
      | ClickedOnPhoneNumber | Clicked on Phone Number |
      | ClickToPrimaryHostedSite | Click to Primary Hosted Site |
      | Comments | Comments |
      | DetailedView | Detailed View |
      | Discard | Discard |
      | DrivingDirections | Driving Directions |
      | ExitDetailedView | Exit Detailed View |
      | Favorited | Favorited |
      | Maybe | Maybe |
      | NonDetailedView | Non-Detailed View |
      ...
      | Search | Search |
      | Share | Share |
      | SubmissionOfLeadForm | Submission of Lead Form |
      | VirtualTour | Virtual Tour |
    But "EventType" MUST NOT contain any similar lookups
  ...
  Scenario: ObjectIdType
    ...
    And "ObjectIdType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Listingid | ListingId |
      ...
      | Unique | Unique |
    But "ObjectIdType" MUST NOT contain any similar lookups
  ...
  Scenario: ObjectType
    ...
    And "ObjectType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Document | Document |
      | Listing | Listing |
      ...
      | VirtualTour | Virtual Tour |
    But "ObjectType" MUST NOT contain any similar lookups
