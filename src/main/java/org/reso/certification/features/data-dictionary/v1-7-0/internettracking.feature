...
Feature: InternetTracking
  ...
  Scenario: ActorLatitude
    ...
    And "ActorLatitude" precision SHOULD be equal to the RESO Suggested Max Length of 12
  ...
  Scenario: ActorLongitude
    ...
    And "ActorLongitude" precision SHOULD be equal to the RESO Suggested Max Length of 12
