...
Feature: InternetTracking
  ...
  Scenario: ActorStateOrProvince
    ...
    And "ActorStateOrProvince" MAY contain any of the standard lookups
  ...
  Scenario: ActorType
    ...
    And "ActorType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agent | Agent |
      | Bot | Bot |
      | Client | Client |
  ...
  Scenario: DeviceType
    ...
    And "DeviceType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Desktop | Desktop |
      | Mobile | Mobile |
      | Tablet | Tablet |
  ...
  Scenario: EventTarget
    ...
    And "EventTarget" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Agent | Agent |
      | Broker | Broker |
      | Digg | Digg |
  ...
  Scenario: EventType
    ...
    And "EventType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ObjectIdType
    ...
    And "ObjectIdType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Listingid | ListingId |
  ...
  Scenario: ObjectType
    ...
    And "ObjectType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Document | Document |
      | Listing | Listing |
