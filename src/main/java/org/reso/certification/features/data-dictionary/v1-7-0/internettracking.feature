...
Feature: InternetTracking
  ...
  Scenario: ActorStateOrProvince
    ...
    And "ActorStateOrProvince" enum types MUST have at least one member
    ...
    And "ActorStateOrProvince" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: ActorType
    ...
    And "ActorType" enum types MUST have at least one member
    Then "ActorType" MUST be "String" data type
    And "ActorType" should only contain enum values found in the metadata
    And "ActorType" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: DeviceType
    ...
    And "DeviceType" enum types MUST have at least one member
    Then "DeviceType" MUST be "String" data type
    And "DeviceType" should only contain enum values found in the metadata
    And "DeviceType" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: EventTarget
    ...
    And "EventTarget" enum types MUST have at least one member
    Then "EventTarget" MUST be "String" data type
    And "EventTarget" should only contain enum values found in the metadata
    And "EventTarget" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: EventType
    ...
    And "EventType" enum types MUST have at least one member
    Then "EventType" MUST be "String" data type
    And "EventType" should only contain enum values found in the metadata
    And "EventType" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: ObjectIdType
    ...
    And "ObjectIdType" enum types MUST have at least one member
    Then "ObjectIdType" MUST be "String" data type
    And "ObjectIdType" should only contain enum values found in the metadata
    And "ObjectIdType" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: ObjectType
    ...
    And "ObjectType" enum types MUST have at least one member
    Then "ObjectType" MUST be "String" data type
    And "ObjectType" should only contain enum values found in the metadata
    And "ObjectType" enumerations must match  MUST have annotations if they contain special characters
