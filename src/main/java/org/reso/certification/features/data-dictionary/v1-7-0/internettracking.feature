...
Feature: InternetTracking
  ...
  Scenario: ActorStateOrProvince
    ...
    And "ActorStateOrProvince" enum types MUST allow only one member
  ...
  Scenario: ActorType
    ...
    And "ActorType" enum types MUST allow only one member
  ...
  Scenario: DeviceType
    ...
    And "DeviceType" enum types MUST allow only one member
  ...
  Scenario: EventTarget
    ...
    And "EventTarget" enum types MUST allow only one member
  ...
  Scenario: EventType
    ...
    And "EventType" enum types MUST allow only one member
  ...
  Scenario: ObjectIdType
    ...
    And "ObjectIdType" enum types MUST allow only one member
  ...
  Scenario: ObjectType
    ...
    And "ObjectType" enum types MUST allow only one member
