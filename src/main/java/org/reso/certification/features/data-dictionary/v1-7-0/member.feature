...
Feature: Member
  ...
  Scenario: MemberAOR
    ...
    And "MemberAOR" enum types MUST allow only one member
  ...
  Scenario: MemberCountry
    ...
    And "MemberCountry" enum types MUST allow only one member
  ...
  Scenario: MemberCountyOrParish
    ...
    And "MemberCountyOrParish" enum types MUST allow only one member
  ...
  Scenario: MemberMlsSecurityClass
    ...
    And "MemberMlsSecurityClass" enum types MUST allow only one member
  ...
  Scenario: MemberOtherPhoneType
    ...
    And "MemberOtherPhoneType" enum types MUST allow only one member
  ...
  Scenario: MemberOtherPhone_TYPE_PLACEHOLDER_Ext
    Given "MemberOtherPhone_TYPE_PLACEHOLDER_Ext" exists in the "Member" metadata
  ...
  Scenario: MemberOtherPhone_TYPE_PLACEHOLDER_Number
    Given "MemberOtherPhone_TYPE_PLACEHOLDER_Number" exists in the "Member" metadata
  ...
  Scenario: MemberStateLicenseState
    ...
    And "MemberStateLicenseState" enum types MUST allow only one member
  ...
  Scenario: MemberStateOrProvince
    ...
    And "MemberStateOrProvince" enum types MUST allow only one member
  ...
  Scenario: MemberStatus
    ...
    And "MemberStatus" enum types MUST allow only one member
  ...
  Scenario: MemberType
    ...
    And "MemberType" enum types MUST allow only one member
  ...
  Scenario: SocialMedia_TYPE_PLACEHOLDER_UrlOrId
    Given "SocialMedia_TYPE_PLACEHOLDER_UrlOrId" exists in the "Member" metadata
