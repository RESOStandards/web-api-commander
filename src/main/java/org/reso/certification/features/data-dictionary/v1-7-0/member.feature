...
Feature: Member
  ...
  Scenario: MemberCountry
    ...
    And "MemberCountry" MAY contain any of the standard lookups
  ...
  Scenario: MemberDesignation
    ...
    And "MemberDesignation" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: MemberLanguages
    ...
    And "MemberLanguages" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Abkhazian | Abkhazian |
      | Afar | Afar |
      | Afrikaans | Afrikaans |
  ...
  Scenario: MemberOtherPhoneType
    ...
    And "MemberOtherPhoneType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Direct | Direct |
      | Fax | Fax |
      | First | First |
  ...
  Scenario: MemberStateLicenseState
    ...
    And "MemberStateLicenseState" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: MemberStateOrProvince
    ...
    And "MemberStateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: MemberStatus
    ...
    And "MemberStatus" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Active | Active |
      | Inactive | Inactive |
  ...
  Scenario: MemberType
    ...
    And "MemberType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Assistant | Assistant |
