...
Feature: Office
  ...
  Scenario: OfficeBranchType
    ...
    And "OfficeBranchType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Branch | Branch |
      | Main | Main |
      | StandAlone | Stand Alone |
    But "OfficeBranchType" MUST NOT contain any similar lookups
  ...
  Scenario: OfficeStateOrProvince
    ...
    And "OfficeStateOrProvince" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
      ...
      | WY | WY |
      | YT | YT |
    But "OfficeStateOrProvince" MUST NOT contain any similar lookups
  ...
  Scenario: OfficeStatus
    ...
    And "OfficeStatus" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Active | Active |
      | Inactive | Inactive |
    But "OfficeStatus" MUST NOT contain any similar lookups

  @Office
  Scenario: OfficeType
    When "OfficeType" exists in the "Office" metadata
    Then "OfficeType" MUST be "Single Enumeration" data type
    And "OfficeType" MAY contain any of the following standard lookups
      | lookupValue | lookupDisplayName |
      | Affiliate | Affiliate |
      | Appraiser | Appraiser |
    ...
    But "OfficeType" MUST NOT contain any similar lookups
