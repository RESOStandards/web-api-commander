...
Feature: Office
  ...
  Scenario: OfficeAOR
    ...
    Then "OfficeAOR" is defined as a single-valued enumeration
    And "OfficeAOR" standard enumeration values exist in the metadata
  ...
  Scenario: OfficeBranchType
    ...
    Then "OfficeBranchType" is defined as a single-valued enumeration
    And "OfficeBranchType" standard enumeration values exist in the metadata
  ...
  Scenario: OfficeCountyOrParish
    ...
    Then "OfficeCountyOrParish" is defined as a single-valued enumeration
    And "OfficeCountyOrParish" standard enumeration values exist in the metadata
  ...
  Scenario: OfficeStateOrProvince
    ...
    Then "OfficeStateOrProvince" is defined as a single-valued enumeration
    And "OfficeStateOrProvince" standard enumeration values exist in the metadata

  @OfficeStatus @Office
  Scenario: OfficeStatus
    When "OfficeStatus" exists in the "Office" metadata
    Then "OfficeStatus" is defined as a single-valued enumeration
    And "OfficeStatus" standard enumeration values exist in the metadata

  @OfficeType @Office
  Scenario: OfficeType
    When "OfficeType" exists in the "Office" metadata
    Then "OfficeType" is defined as a single-valued enumeration
    And "OfficeType" standard enumeration values exist in the metadata
  ...
  Scenario: SyndicateAgentOption
    ...
    Then "SyndicateAgentOption" is defined as a single-valued enumeration
    And "SyndicateAgentOption" standard enumeration values exist in the metadata
