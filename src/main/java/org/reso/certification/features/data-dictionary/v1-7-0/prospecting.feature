...
Feature: Prospecting
  ...
  Scenario: DailySchedule
    ...
    Then "DailySchedule" is defined as a multi-valued enumeration
    And "DailySchedule" standard enumeration values exist in the metadata
  ...
  Scenario: Language
    ...
    Then "Language" is defined as a single-valued enumeration
  ...
  Scenario: ReasonActiveOrDisabled
    ...
    Then "ReasonActiveOrDisabled" is defined as a single-valued enumeration
    And "ReasonActiveOrDisabled" standard enumeration values exist in the metadata
  ...
  Scenario: ScheduleType
    ...
    Then "ScheduleType" is defined as a single-valued enumeration
    And "ScheduleType" standard enumeration values exist in the metadata
