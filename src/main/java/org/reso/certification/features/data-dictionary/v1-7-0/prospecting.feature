...
Feature: Prospecting
  ...
  Scenario: Language
    ...
    And "Language" enum types MUST allow only one member
  ...
  Scenario: ReasonActiveOrDisabled
    ...
    And "ReasonActiveOrDisabled" enum types MUST allow only one member
  ...
  Scenario: ScheduleType
    ...
    And "ScheduleType" enum types MUST allow only one member
