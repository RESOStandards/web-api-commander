...
Feature: Prospecting
  ...
  Scenario: DailySchedule
    ...
    And "DailySchedule" MAY contain any of the standard lookups
  ...
  Scenario: ReasonActiveOrDisabled
    ...
    And "ReasonActiveOrDisabled" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
  ...
  Scenario: ScheduleType
    ...
    And "ScheduleType" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | ASAP | ASAP |
      | Daily | Daily |
      | Monthly | Monthly |
