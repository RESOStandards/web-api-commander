...
Feature: Teams
  ...
  Scenario: TeamCountry
    ...
    And "TeamCountry" MAY contain any of the following standard lookups
      ...
      | ZM | ZM |
      | ZW | ZW |
    But "TeamCountry" MUST NOT contain any similar lookups
  ...
  Scenario: TeamLeadStateLicenseState
    ...
    And "TeamLeadStateLicenseState" MAY contain any of the following standard lookups
      ...
      | WY | WY |
      | YT | YT |
    But "TeamLeadStateLicenseState" MUST NOT contain any similar lookups
  ...
  Scenario: TeamStateOrProvince
    ...
    And "TeamStateOrProvince" MAY contain any of the following standard lookups
      ...
      | WY | WY |
      | YT | YT |
    But "TeamStateOrProvince" MUST NOT contain any similar lookups
  ...
  Scenario: TeamStatus
    ...
    And "TeamStatus" MAY contain any of the following standard lookups
      ...
      | Active | Active |
      | Inactive | Inactive |
    But "TeamStatus" MUST NOT contain any similar lookups
