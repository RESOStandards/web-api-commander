...
Feature: Teams
  ...
  Scenario: TeamCountry
    ...
    And "TeamCountry" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: TeamCountyOrParish
    ...
    And "TeamCountyOrParish" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: TeamLeadStateLicenseState
    ...
    And "TeamLeadStateLicenseState" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: TeamStateOrProvince
    ...
    And "TeamStateOrProvince" enumerations must match  MUST have annotations if they contain special characters
  ...
  Scenario: TeamStatus
    ...
    And "TeamStatus" enumerations must match  MUST have annotations if they contain special characters
