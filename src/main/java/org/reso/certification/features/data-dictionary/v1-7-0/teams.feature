...
Feature: Teams
  ...
  Scenario: TeamCountry
    ...
    And "TeamCountry" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AD | AD |
      | AE | AE |
      | AF | AF |
  ...
  Scenario: TeamLeadStateLicenseState
    ...
    And "TeamLeadStateLicenseState" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: TeamStateOrProvince
    ...
    And "TeamStateOrProvince" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | AB | AB |
      | AK | AK |
      | AL | AL |
  ...
  Scenario: TeamStatus
    ...
    And "TeamStatus" MAY contain any of the standard lookups
      | lookupValue | lookupDisplayName |
      | Active | Active |
      | Inactive | Inactive |
