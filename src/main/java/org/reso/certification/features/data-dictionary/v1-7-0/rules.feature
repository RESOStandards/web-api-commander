...
Feature: Rules
  ...
  Scenario: RuleFormat
    ...
    Then "RuleFormat" is defined as a single-valued enumeration
    And "RuleFormat" standard enumeration values exist in the metadata
  ...
  Scenario: RuleType
    ...
    Then "RuleType" is defined as a single-valued enumeration
    And "RuleType" standard enumeration values exist in the metadata
