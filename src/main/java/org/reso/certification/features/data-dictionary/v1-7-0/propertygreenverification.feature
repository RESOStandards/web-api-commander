...
Feature: PropertyGreenVerification
  ...
  Scenario: GreenBuildingVerificationKey
    Given "GreenBuildingVerificationKey" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenBuildingVerificationKeyNumeric
    Given "GreenBuildingVerificationKeyNumeric" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenBuildingVerificationType
    Given "GreenBuildingVerificationType" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationBody
    Given "GreenVerificationBody" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationMetric
    Given "GreenVerificationMetric" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationRating
    Given "GreenVerificationRating" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationSource
    Given "GreenVerificationSource" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationStatus
    Given "GreenVerificationStatus" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationURL
    Given "GreenVerificationURL" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationVersion
    Given "GreenVerificationVersion" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: GreenVerificationYear
    Given "GreenVerificationYear" exists in the "PropertyGreenVerification" metadata
    Then "GreenVerificationYear" MUST be "Integer" data type

  @ListingId @PropertyGreenVerification
  Scenario: ListingId
    Given "ListingId" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: ListingKey
    Given "ListingKey" exists in the "PropertyGreenVerification" metadata
  ...
  Scenario: ListingKeyNumeric
    Given "ListingKeyNumeric" exists in the "PropertyGreenVerification" metadata
    Then "ListingKeyNumeric" MUST be "Integer" data type

  @ModificationTimestamp @PropertyGreenVerification
  Scenario: ModificationTimestamp
    Given "ModificationTimestamp" exists in the "PropertyGreenVerification" metadata
