...
Feature: PropertyGreenVerification
  ...
  Scenario: GreenBuildingVerificationType
    ...
    Then "GreenBuildingVerificationType" is defined as a single-valued enumeration
  ...
  Scenario: GreenVerificationSource
    ...
    Then "GreenVerificationSource" is defined as a single-valued enumeration
    And "GreenVerificationSource" standard enumeration values exist in the metadata
  ...
  Scenario: GreenVerificationStatus
    ...
    Then "GreenVerificationStatus" is defined as a single-valued enumeration
    And "GreenVerificationStatus" standard enumeration values exist in the metadata
