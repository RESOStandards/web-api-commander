...
Feature: PropertyGreenVerification
  ...
  Scenario: GreenBuildingVerificationType
    ...
    And "GreenBuildingVerificationType" enum types MUST allow only one member
  ...
  Scenario: GreenVerificationSource
    ...
    And "GreenVerificationSource" enum types MUST allow only one member
  ...
  Scenario: GreenVerificationStatus
    ...
    And "GreenVerificationStatus" enum types MUST allow only one member
